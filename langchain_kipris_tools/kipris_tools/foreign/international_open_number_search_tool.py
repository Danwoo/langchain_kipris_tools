...
class ForeignPatentInternationalOpenNumberSearchArgs(BaseModel):
    international_open_number: str = Field(
        "",
        description="International publication number, looks up specific international patent by exact publication number, use international publication number format from various patent offices",
    )

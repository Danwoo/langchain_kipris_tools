from langchain_kipris_tools.kipris_api.foreign.patent_search_api import PatentSearchAPI
...
class ForeignPatentSearchArgs(BaseModel):
...
class ForeignPatentSearchTool(BaseTool):
    name:str = "foreign_patent_search"
    description:str = "foreign patent search by user input keyword"
    api:PatentSearchAPI = PatentSearchAPI()
    args_schema:t.Type[BaseModel] = ForeignPatentSearchArgs

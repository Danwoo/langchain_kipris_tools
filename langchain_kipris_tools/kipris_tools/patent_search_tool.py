...
class PatentSearchTool(BaseTool):
    ...
    def _run(self, word:str, invention_title:str='', abst_cont:str='', claim_scope:str='', ipc_number:str='', application_number:str='', open_number:str='', register_number:str='', priority_application_number:str='', international_application_number:str='', international_open_number:str='', application_date:str='', open_date:str='', publication_date:str='', register_date:str='', priority_application_date:str='', international_application_date:str='', international_open_date:str='', applicant:str='', inventor:str='', agent:str='', right_holder:str='', patent:bool=True, utility:bool=True, lastvalue:str='', page_no:int=1, num_of_rows:int=10, desc_sort:bool=True, sort_spec:str='AD')->pd.DataFrame:
        result = self.api.search(word=word, invention_title=invention_title, abst_cont=abst_cont, claim_scope=claim_scope, ipc_number=ipc_number, application_number=application_number, open_number=open_number, register_number=register_number, priority_application_number=priority_application_number, international_application_number=international_application_number, international_open_number=international_open_number, application_date=application_date, open_date=open_date, publication_date=publication_date, register_date=register_date, priority_application_date=priority_application_date, international_application_date=international_application_date, international_open_date=international_open_date, applicant=applicant, inventor=inventor, agent=agent, right_holder=right_holder, patent=patent, utility=utility, lastvalue=lastvalue, page_no=page_no, num_of_rows=num_of_rows, desc_sort=desc_sort, sort_spec=sort_spec)
        return result

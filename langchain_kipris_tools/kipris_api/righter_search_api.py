...
class RighterSearchAPI(ABSKiprisAPI):
    def __init__(self, **kwargs):
        ...
        self.api_url = "http://plus.kipris.or.kr/openapi/rest/patUtiModInfoSearchSevice/righterSearchInfo"
    def search(self, righter:str,
                               docs_start:int=1,
                               docs_count:int=10,
                               patent:bool=True,
                               utility:bool=True,
        ...
        response = self.common_call(api_url=self.api_url, righter=righter,
